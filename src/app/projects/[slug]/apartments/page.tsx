  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">Select an apartment</h1>
      </div>
      <ApartmentSelector projectSlug={project.slug} apartments={project.apartments} />
    </div>
  );
}
